  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Tasks',
          tabBarIcon: ({ color, size }) => <TabIcon Icon={ListTodo} color={color} size={size} />,
        }}
      />
      <Tabs.Screen
        name="shop"
        options={{
          title: 'Shop',
          tabBarIcon: ({ color, size }) => <TabIcon Icon={ShoppingCart} color={color} size={size} />,
        }}
      />
      <Tabs.Screen
        name="finances"
        options={{
          title: 'Finances',
          tabBarIcon: ({ color, size }) => <TabIcon Icon={DollarSign} color={color} size={size} />,
        }}
      />
      <Tabs.Screen
        name="calendar"
